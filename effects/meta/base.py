## This file is a copy of the causalml.inference.meta.base.BaseLearner class, but with the imports fixed to work with the current version of the code.
...
from effects.meta.explainer import Explainer
from effects.meta.utils import check_p_conditions, convert_pd_to_np
from effects.propensity import compute_propensity_score
