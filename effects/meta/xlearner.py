## This file is a copy of the causalml.inference.meta.xlearner.BaseXLearner class, but with the imports fixed to work with the current version of the code.
...
from effects.meta.base import BaseLearner
from effects.meta.utils import (
    check_treatment_vector,
    convert_pd_to_np,
)
from effects.metrics import regression_metrics, classification_metrics
